...
def save_model():
    if use_cuda:
        net.cpu()
    torch.save(net.state_dict(), "/home/giridhar21026/sarcasm/LearningToPaint/renderer.pkl")
    if use_cuda:
        net.cuda()


def load_weights():
    pretrained_dict = torch.load("/home/giridhar21026/sarcasm/LearningToPaint/renderer.pkl")
